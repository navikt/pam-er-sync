...
@Service
public class ElasticSearchIndexerService implements IndexerService {

    private static final Logger LOG = LoggerFactory.getLogger(ElasticSearchIndexerService.class);
    ...
    public ElasticSearchIndexerService(ElasticSearchIndexClient elasticSearchIndexClient) {
